    ...
    <section className="py-20 md:py-32 bg-gray-50" id="how-it-works">
      <div className="container mx-auto px-4 md:px-8 lg:px-16">
        <div className="text-center max-w-3xl mx-auto mb-16 scroll-animate">
          <h2 className="text-4xl md:text-5xl mb-4 text-gray-900">{t('howItWorks.title')}</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 lg:gap-12">
          ...
          >
            <div className="text-center space-y-4 group">
              ...
              <h3 className="text-2xl text-gray-900 pt-4">{t('howItWorks.step1.title')}</h3>
          ...
          >
            <div className="text-center space-y-4 group">
              ...
              <h3 className="text-2xl text-gray-900 pt-4">{t('howItWorks.step2.title')}</h3>
          ...
          >
            <div className="text-center space-y-4 group">
              ...
              <h3 className="text-2xl text-gray-900 pt-4">{t('howItWorks.step3.title')}</h3>
