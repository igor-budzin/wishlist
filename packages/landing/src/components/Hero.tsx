...
export function Hero({ loginUrl }: HeroProps) {
  ...
  return (
    <section id="hero" className="relative overflow-hidden bg-gradient-to-br from-[#4F46E5] to-[#6366F1] text-white pt-32 md:pt-40">
      <div className="container mx-auto px-4 md:px-8 lg:px-16 py-20 md:py-32">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-6">
            <h1 className="text-5xl md:text-6xl lg:text-7xl tracking-tight hero-animate" style={{ '--delay': '0ms' } as React.CSSProperties}>
              {t('hero.title')}
            </h1>
            <p className="text-xl md:text-2xl text-indigo-100 hero-animate" style={{ '--delay': '150ms' } as React.CSSProperties}>
              {t('hero.subtitle')}
            </p>
            <div className="flex flex-col sm:flex-row gap-4 pt-4 hero-animate" style={{ '--delay': '300ms' } as React.CSSProperties}>
              <a
                href={loginUrl}
          ...
          <div className="relative hero-animate-right" style={{ '--delay': '200ms' } as React.CSSProperties}>
