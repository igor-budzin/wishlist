...
router.get('/items/:id', requireAuth, (req, res, next) => wishlistController.getById(req, res, next));
router.post('/items', requireAuth, validate(createWishlistItemSchema), (req, res, next) => wishlistController.create(req, res, next));
router.put('/items/:id', requireAuth, validate(updateWishlistItemSchema), (req, res, next) => wishlistController.update(req, res, next));
router.delete('/items/:id', requireAuth, (req, res, next) => wishlistController.delete(req, res, next));
